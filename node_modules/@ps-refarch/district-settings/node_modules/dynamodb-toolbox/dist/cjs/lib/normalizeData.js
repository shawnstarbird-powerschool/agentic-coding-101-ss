...
// Normalize Data
exports.default = () => (schema, linked, data, filter = false, throwOnMissingNonPartitionRequiredProperties = true) => {
        ...
        if (schema[attr].dependsOn) {
            (Array.isArray(schema[attr].dependsOn)
                ...
                if (schema[dependent]) {
                    ...
                    (0, utils_js_1.error)(`'${dependent}' is not a valid attribute or alias name`);
                }
            });
        ...
        return Object.assign(acc, schema[field]
            ...
            : filter
                ...
                : field === '$remove'
                    ...
                    : (0, utils_js_1.error)(`Field '${field}' does not have a mapping or alias`));
    }, { data: {}, aliases: {} });
    ...
    const composites = Object.keys(linked).reduce((acc, attr) => {
        ...
        const values = linked[attr]
            ...
            return (0, utils_js_1.transformAttr)(schema[f], validateType(schema[f], f, _data[f]), _data);
        })
            .filter((x) => x !== null);
