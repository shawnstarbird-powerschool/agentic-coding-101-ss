...
const parseEntityAttributes_js_1 = __importDefault(require("./parseEntityAttributes.js"));
...
function parseEntity(entity) {
    ...
    if (Object.keys(args).length > 0)
        (0, utils_js_1.error)(`Invalid Entity configuration options: ${Object.keys(args).join(', ')}`);
    // 🔨 TOIMPROVE: Not triming would be better for type safety (no need to cast)
    // Entity name
    name = (typeof name === 'string' && name.trim().length > 0
        ? name.trim()
        : (0, utils_js_1.error)(`'name' must be defined`));
    ...
    attributes =
        (attributes === null || attributes === void 0 ? void 0 : attributes.constructor) === Object
            ? attributes
            : (0, utils_js_1.error)(`Please provide a valid 'attributes' object`);
    // Add timestamps
    if (timestamps) {
        attributes[created] = {
            type: 'string',
    ...
    const schema = (0, parseEntityAttributes_js_1.default)(attributes, track); // removed nested attribute?
        ...
        Object.keys(schema.attributes).forEach((field) => {
            ...
            if (config.type && config.type === 'bigint' || config.setType && config.setType === 'bigint') {
                ...
                if (((_d = (_c = (_b = (_a = table === null || table === void 0 ? void 0 : table.DocumentClient) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.translateConfig) === null || _c === void 0 ? void 0 : _c.unmarshallOptions) === null || _d === void 0 ? void 0 : _d.wrapNumbers) !== true) {
                    (0, utils_js_1.error)('Please set `wrapNumbers: true` in your DocumentClient to avoid losing precision with bigint fields');
                }
            }
        });
    }
