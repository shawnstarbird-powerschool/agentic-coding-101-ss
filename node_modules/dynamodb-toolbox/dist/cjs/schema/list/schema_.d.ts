...
type ListSchemer = <ELEMENTS extends ListElementSchema, PROPS extends SchemaProps = {}>(elements: ELEMENTS, props?: NarrowObject<PROPS>) => ListSchema_<Light<ELEMENTS>, PROPS>;
/**
 ...
 */
export declare const list: ListSchemer;
/**
 * List attribute interface
 */
export declare class ListSchema_<ELEMENTS extends Schema = Schema, PROPS extends SchemaProps = SchemaProps> extends ListSchema<ELEMENTS, PROPS> {
    /**
     ...
     */
    required<NEXT_IS_REQUIRED extends SchemaRequiredProp = AtLeastOnce>(nextRequired?: NEXT_IS_REQUIRED): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        required: NEXT_IS_REQUIRED;
    }>>;
    /**
     * Shorthand for `required('never')`
     */
    optional(): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        required: Never;
    }>>;
    /**
     * Hide attribute after fetch commands and formatting
     */
    hidden<NEXT_HIDDEN extends boolean = true>(nextHidden?: NEXT_HIDDEN): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        hidden: NEXT_HIDDEN;
    }>>;
    /**
     * Tag attribute as a primary key attribute or linked to a primary attribute
     */
    key<NEXT_KEY extends boolean = true>(nextKey?: NEXT_KEY): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        key: NEXT_KEY;
        required: Always;
    }>>;
    /**
     ...
     */
    savedAs<NEXT_SAVED_AS extends string | undefined>(nextSavedAs: NEXT_SAVED_AS): ListSchema_<ELEMENTS, Overwrite<PROPS, {
    ...
    keyDefault(nextKeyDefault: ValueOrGetter<ValidValue<this, {
        mode: 'key';
    }>>): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        keyDefault: unknown;
    }>>;
    /**
     ...
     */
    putDefault(nextPutDefault: ValueOrGetter<ValidValue<this>>): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        putDefault: unknown;
    }>>;
    /**
    ...
    default(nextDefault: ValueOrGetter<If<PROPS['key'], ValidValue<this, {
        mode: 'key';
    }>, ValidValue<this>>>): If<PROPS['key'], ListSchema_<ELEMENTS, Overwrite<PROPS, {
        keyDefault: unknown;
    }>>, ListSchema_<ELEMENTS, Overwrite<PROPS, {
        putDefault: unknown;
    }>>>;
    ...
    putLink<SCHEMA extends Schema>(nextPutLink: (putItemInput: ValidValue<SCHEMA, {
        defined: true;
    }>) => ValidValue<this>): ListSchema_<ELEMENTS, Overwrite<PROPS, {
        putLink: unknown;
    }>>;
    /**
    ...
    keyValidate(nextKeyValidator: Validator<ValidValue<this, {
        mode: 'key';
        defined: true;
    }>, this>): ListSchema_<ELEMENTS, Overwrite<PROPS, {
    ...
    validate(nextValidator: Validator<If<PROPS['key'], ValidValue<this, {
        ...
        defined: true;
    }>>, this>): If<PROPS['key'], ListSchema_<ELEMENTS, Overwrite<PROPS, {
        keyValidator: Validator;
    }>>, ListSchema_<ELEMENTS, Overwrite<PROPS, {
        putValidator: Validator;
    }>>>;
    clone<NEXT_PROPS extends SchemaProps = {}>(nextProps?: NarrowObject<NEXT_PROPS>): ListSchema_<ELEMENTS, Overwrite<PROPS, NEXT_PROPS>>;
