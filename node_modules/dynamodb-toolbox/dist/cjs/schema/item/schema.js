    ...
    check(path) {
        ...
        for (const [attributeName, attribute] of Object.entries(this.attributes)) {
            ...
            if (attributesSavedAs.has(attributeSavedAs)) {
                throw new index_js_1.DynamoDBToolboxError('schema.item.duplicateSavedAs', {
                    message: `Invalid item attributes${path !== undefined ? ` at path '${path}'` : ''}: More than two attributes are saved as '${attributeSavedAs}'.`,
                    path,
