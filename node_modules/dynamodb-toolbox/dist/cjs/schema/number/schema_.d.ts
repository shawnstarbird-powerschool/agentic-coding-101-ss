...
type NumberSchemer = <PROPS extends Omit<NumberSchemaProps, 'enum'> = {}>(props?: NarrowObject<PROPS>) => NumberSchema_<PROPS>;
/**
 * Define a new schema of number type
 *
 * @param props _(optional)_ Schema Props
 */
export declare const number: NumberSchemer;
/**
 * Number attribute (warm)
 */
export declare class NumberSchema_<PROPS extends NumberSchemaProps = NumberSchemaProps> extends NumberSchema<PROPS> {
    /**
     ...
     */
    required<NEXT_IS_REQUIRED extends SchemaRequiredProp = AtLeastOnce>(nextRequired?: NEXT_IS_REQUIRED): NumberSchema_<Overwrite<PROPS, {
        required: NEXT_IS_REQUIRED;
    }>>;
    /**
     * Shorthand for `required('never')`
     */
    optional(): NumberSchema_<Overwrite<PROPS, {
        required: Never;
    }>>;
    /**
     * Hide attribute after fetch commands and formatting
     */
    hidden<NEXT_HIDDEN extends boolean = true>(nextHidden?: NEXT_HIDDEN): NumberSchema_<Overwrite<PROPS, {
        hidden: NEXT_HIDDEN;
    }>>;
    /**
     * Tag attribute as a primary key attribute or linked to a primary attribute
     */
    key<NEXT_KEY extends boolean = true>(nextKey?: NEXT_KEY): NumberSchema_<Overwrite<PROPS, {
        key: NEXT_KEY;
        required: Always;
    }>>;
    /**
     ...
     */
    savedAs<NEXT_SAVED_AS extends string | undefined>(nextSavedAs: NEXT_SAVED_AS): NumberSchema_<Overwrite<PROPS, {
     ...
     * string().enum('foo', 'bar')
     */
    enum<const NEXT_ENUM extends readonly ResolveNumberSchema<this>[]>(...nextEnum: NEXT_ENUM): NumberSchema_<Overwrite<PROPS, {
        enum: Writable<NEXT_ENUM>;
    }>>;
    /**
     ...
     * string().const('foo')
     */
    const<CONSTANT extends ResolveNumberSchema<this>>(constant: CONSTANT): If<PROPS['key'], NumberSchema_<Overwrite<PROPS, {
        enum: [CONSTANT];
        keyDefault: unknown;
    }>>, NumberSchema_<Overwrite<PROPS, {
        enum: [CONSTANT];
        putDefault: unknown;
    }>>>;
    /**
     ...
     */
    transform<TRANSFORMER extends Transformer<ResolvedNumberSchema, ResolveNumberSchema<this>>>(transform: TRANSFORMER): NumberSchema_<Overwrite<PROPS, {
        transform: TRANSFORMER;
    }>>;
    /**
     * Allow BigInts
     */
    big<NEXT_BIG extends boolean = true>(nextBig?: NEXT_BIG): NumberSchema_<Overwrite<PROPS, {
        big: NEXT_BIG;
    }>>;
    /**
     ...
     */
    putDefault(nextPutDefault: ValueOrGetter<ValidValue<this>>): NumberSchema_<Overwrite<PROPS, {
        putDefault: unknown;
    }>>;
    /**
    ...
    default(nextDefault: ValueOrGetter<If<PROPS['key'], ValidValue<this, {
        mode: 'key';
    }>, ValidValue<this>>>): If<PROPS['key'], NumberSchema_<Overwrite<PROPS, {
        keyDefault: unknown;
    }>>, NumberSchema_<Overwrite<PROPS, {
        putDefault: unknown;
    }>>>;
    ...
    putLink<SCHEMA extends Schema>(nextPutLink: (putItemInput: ValidValue<SCHEMA, {
        defined: true;
    }>) => ValidValue<this>): NumberSchema_<Overwrite<PROPS, {
        putLink: unknown;
    }>>;
    /**
    ...
    keyValidate(nextKeyValidator: Validator<ValidValue<this, {
        mode: 'key';
        defined: true;
    }>, this>): NumberSchema_<Overwrite<PROPS, {
    ...
    validate(nextValidator: Validator<If<PROPS['key'], ValidValue<this, {
        ...
        defined: true;
    }>>, this>): If<PROPS['key'], NumberSchema_<Overwrite<PROPS, {
        keyValidator: Validator;
    }>>, NumberSchema_<Overwrite<PROPS, {
        putValidator: Validator;
    }>>>;
    clone<NEXT_PROPS extends NumberSchemaProps = {}>(nextProps?: NarrowObject<NEXT_PROPS>): NumberSchema_<Overwrite<PROPS, NEXT_PROPS>>;
