...
exports.UpdateAttributesCommand = void 0;
...
const index_js_4 = require("./updateAttributesParams/index.js");
class UpdateAttributesCommand extends index_js_2.EntityAction {
    ...
    item(nextItem) {
        return new UpdateAttributesCommand(this.entity, nextItem, this[constants_js_2.$options]);
    }
    options(nextOptions) {
        return new UpdateAttributesCommand(this.entity, this[constants_js_2.$item], nextOptions);
    }
    ...
    params() {
        ...
        return (0, index_js_4.updateAttributesParams)(this.entity, item, options);
    }
...
exports.UpdateAttributesCommand = UpdateAttributesCommand;
UpdateAttributesCommand.actionName = 'updateAttributes';
__decorate([
    (0, decorator_js_1.interceptable)()
], UpdateAttributesCommand.prototype, "send", null);
