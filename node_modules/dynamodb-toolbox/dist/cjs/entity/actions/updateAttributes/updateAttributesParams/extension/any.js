...
exports.parseAnyExtension = void 0;
...
const parseAnyExtension = (schema, input, { transform = true, valuePath } = {}) => {
    if ((0, isObject_js_1.isObject)(input) || (0, isArray_js_1.isArray)(input)) {
        return {
            isExtension: true,
            *extensionParser() {
...
exports.parseAnyExtension = parseAnyExtension;
