...
type BooleanSchemer = <PROPS extends BooleanSchemaProps = {}>(props?: NarrowObject<PROPS>) => BooleanSchema_<PROPS>;
/**
 * Define a new schema of boolean type
 *
 * @param props _(optional)_ Schema Props
 */
export declare const boolean: BooleanSchemer;
/**
 * Boolean attribute (warm)
 */
export declare class BooleanSchema_<PROPS extends BooleanSchemaProps = BooleanSchemaProps> extends BooleanSchema<PROPS> {
    /**
     ...
     */
    required<NEXT_IS_REQUIRED extends SchemaRequiredProp = AtLeastOnce>(nextRequired?: NEXT_IS_REQUIRED): BooleanSchema_<Overwrite<PROPS, {
        required: NEXT_IS_REQUIRED;
    }>>;
    /**
     * Shorthand for `required('never')`
     */
    optional(): BooleanSchema_<Overwrite<PROPS, {
        required: Never;
    }>>;
    /**
     * Hide attribute after fetch commands and formatting
     */
    hidden<NEXT_HIDDEN extends boolean = true>(nextHidden?: NEXT_HIDDEN): BooleanSchema_<Overwrite<PROPS, {
        hidden: NEXT_HIDDEN;
    }>>;
    /**
     * Tag attribute as a primary key attribute or linked to a primary attribute
     */
    key<NEXT_KEY extends boolean = true>(nextKey?: NEXT_KEY): BooleanSchema_<Overwrite<PROPS, {
        key: NEXT_KEY;
        required: Always;
    }>>;
    /**
     ...
     */
    savedAs<NEXT_SAVED_AS extends string | undefined>(nextSavedAs: NEXT_SAVED_AS): BooleanSchema_<Overwrite<PROPS, {
     ...
     * string().enum('foo', 'bar')
     */
    enum<const NEXT_ENUM extends readonly ResolveBooleanSchema<this>[]>(...nextEnum: NEXT_ENUM): BooleanSchema_<Overwrite<PROPS, {
     ...
     * string().const('foo')
     */
    const<CONSTANT extends ResolveBooleanSchema<this>>(constant: CONSTANT): If<PROPS['key'], BooleanSchema_<Overwrite<PROPS, {
        enum: [CONSTANT];
        keyDefault: unknown;
    }>>, BooleanSchema_<Overwrite<PROPS, {
        enum: [CONSTANT];
        putDefault: unknown;
    }>>>;
    /**
     ...
     */
    transform<TRANSFORMER extends Transformer<ResolvedBooleanSchema, ResolveBooleanSchema<this>>>(transform: TRANSFORMER): BooleanSchema_<Overwrite<PROPS, {
     ...
     */
    putDefault(nextPutDefault: ValueOrGetter<ValidValue<this>>): BooleanSchema_<Overwrite<PROPS, {
        putDefault: unknown;
    }>>;
    /**
    ...
    default(nextDefault: ValueOrGetter<If<PROPS['key'], ValidValue<this, {
        mode: 'key';
    }>, ValidValue<this>>>): If<PROPS['key'], BooleanSchema_<Overwrite<PROPS, {
        keyDefault: unknown;
    }>>, BooleanSchema_<Overwrite<PROPS, {
        putDefault: unknown;
    }>>>;
    ...
    putLink<SCHEMA extends Schema>(nextPutLink: (putItemInput: ValidValue<SCHEMA, {
        defined: true;
    }>) => ValidValue<this>): BooleanSchema_<Overwrite<PROPS, {
        putLink: unknown;
    }>>;
    /**
    ...
    keyValidate(nextKeyValidator: Validator<ValidValue<this, {
        mode: 'key';
        defined: true;
    }>, this>): BooleanSchema_<Overwrite<PROPS, {
    ...
    validate(nextValidator: Validator<If<PROPS['key'], ValidValue<this, {
        ...
        defined: true;
    }>>, this>): If<PROPS['key'], BooleanSchema_<Overwrite<PROPS, {
        keyValidator: Validator;
    }>>, BooleanSchema_<Overwrite<PROPS, {
        putValidator: Validator;
    }>>>;
    clone<NEXT_PROPS extends BooleanSchemaProps = {}>(nextProps?: NarrowObject<NEXT_PROPS>): BooleanSchema_<Overwrite<PROPS, NEXT_PROPS>>;
