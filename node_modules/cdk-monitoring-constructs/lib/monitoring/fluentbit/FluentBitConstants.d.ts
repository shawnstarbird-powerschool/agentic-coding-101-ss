export declare enum FluentBitStorageMetricTag {
...
export declare enum FluentBitOutputMetricTag {
...
export declare enum FluentBitInputMetricTag {
    INPUT_RECORDS = "fluentbit_input_records_total"
}
export declare enum FluentBitFilterMetricTag {
...
export declare enum FluentBitMetricsWithoutWidget {
